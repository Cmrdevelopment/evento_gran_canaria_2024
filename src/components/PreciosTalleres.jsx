...
<div className="relative border-2 border-black overflow-hidden">
  {/* Banda diagonal */}
  <div className="absolute -rotate-45 bg-red-500 text-white font-bold md:text-5xl py-9 px-10 top-1/2 left-[-50%] w-[200%] text-center z-20" style={{ letterSpacing: '0.9em' }}>
      COMPLETADO
    </div>
